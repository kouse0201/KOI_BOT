...
MENU = {
    "全日メニュー":{
        ...
        "KOI特選お寿司盛り合わせ(販売停止)":{"price":22500,"cost":8750},
        "KOI特製温泉プリン(販売停止)":{"price":5000,"cost":2500},
        "KOI印温泉饅頭(販売停止)":{"price":5000,"cost":2250},
        "電動マッサージ機(販売停止)":{"price":50000,"cost":25000},
        "肉厚とんかつ定食(販売停止)":{"price":5000,"cost":2500},
        "こいくんケーキ(販売停止)":{"price":5000,"cost":1875},
        "山菜の天ぷら蕎麦(販売停止)":{"price":6500,"cost":2500},
        "KOIの船盛り(販売停止)":{"price":6000,"cost":2500},
        },
    "曜日限定メニュー":{
        ...
        "紫の湯:ぶどう":{"price":5500,"cost":2400},
        "橙の湯:ライチ":{"price":5500,"cost":2750},
        },
    "チル限定メニュー":{
